...
public class ResultsService {
   ...
   */
  public ResultsService(final CountDownLatch countDownLatch, final ExampleConfig config) {
  ...
  public void addResult(final String key, int value) {
    results.computeIfAbsent(key, v -> Collections.synchronizedCollection(new ArrayList<>()))
        .add(value);
